 ...
 * ```
 */
export declare const T: typeof TComp & TComponentProxy & { [Key in keyof Threlte.UserCatalogue]: Component<Props<Threlte.UserCatalogue[Key]>, {}, "ref">; } & Record<string, Component>;
export {};
