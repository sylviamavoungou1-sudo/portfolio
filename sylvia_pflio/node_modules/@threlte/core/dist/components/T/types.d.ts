...
export type Props<Type, ChildrenArgs extends unknown[] = [{
    ref: MaybeInstance<Type>;
}]> = AnyProps & RefProps<Type> & BaseProps<Type, ChildrenArgs> & ClassProps<Type> & CameraProps<Type> & InstanceProps<Type> & EventProps<MaybeInstance<Type>> & Threlte.UserProps;
/**
 * ### `TProps<Type>`
 *
