import "./chunk-O4PHAQCV.js";
import {
  onDestroy,
  onMount
} from "./chunk-K2MD73JE.js";
import "./chunk-U7P2NEEE.js";
import "./chunk-MP67YKBV.js";
import "./chunk-2QJS5JOW.js";
import {
  derived,
  get,
  readable,
...
var isNodeMatchingSelectorFocusable = function isNodeMatchingSelectorFocusable2(options, node) {
  if (node.disabled || isHiddenInput(node) || isHidden2(node, options) || // For a details element with a summary, the summary element gets the focus
...
var createSlider = (props) => {
  ...
  const { min: min2, max: max2, step, orientation, dir, disabled, autoSort, rootElement } = options;
  const valueWritable = withDefaults.value ?? writable(withDefaults.defaultValue);
  const value = overridable(valueWritable, withDefaults == null ? void 0 : withDefaults.onValueChange);
